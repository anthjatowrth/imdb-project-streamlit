...
title_query = "The Wrestler"   
year_query = 1997              

mask = df["Titre"].astype(str).str.strip().str.lower().eq(title_query.strip().lower())
if not mask.any():
...
reco = df.loc[reco_idx, ["Titre", "Année_de_sortie", "Genre", "Pays_origine"]].copy()
